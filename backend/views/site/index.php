 ...
 * Team: "小组"小组
 * Coding by 2012516
 * This is the index of backend site
 */
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      ...
      <div class="carousel-caption">
          ...
          <p>当地时间2022年2月24日，俄罗斯总统普京在对俄罗斯民众发表的特别讲话中宣布，他决定在顿巴斯地区开展特别军事行动。普京表示，俄罗斯没有“侵略”乌克兰的计划，
...
<div class="jumbotron">
  ...
  <p><span class="bgr">俄乌战争是2014年2月20日起俄罗斯与乌克兰之间爆发的一场旷日持久的混合战争，
            前期以低强度战争及代理人战争形式进行。
    ...
    .col-lg-4{ float:left;width:33%;height: 30%;}         
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <p><span class="bgr">郭谨 组长，负责前端开发和用户手册编写
                <p> <span class="bgr">林雨豪 负责用户管理、后台评论管理和展示PPT
                <p><span class="bgr">赵一名 负责模板创建、后端文章功能开发和配置文档编写
                <p><span class="bgr">陈睿颖 负责后端文章功能开发、需求文档和设计文档编写
                <span></p>
            </div>
