 ...
 * Team: "小组"小组
 * Coding by 2011431
 * This is the newstagscloud of frontend components
 */
...
class NewsTagsCloudWidget extends Widget
{
	public $tags;
	...
	public function run()
	{
		...
		{
			$url = Yii::$app->urlManager->createUrl(['news/index','NewsSearch[tags]'=>$tag]);
